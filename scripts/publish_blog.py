...
class CrossPublisher:
    def __init__(self, devto_key: str, hashnode_key: str, medium_token: str, medium_user_id: str):
    ...
    def publish_to_hashnode(self, title: str, body: str, publication_id: str) -> Optional[str]:
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        filepath = sys.argv[1]
        publisher = CrossPublisher(devto_key, hashnode_key, medium_token, medium_user_id)
